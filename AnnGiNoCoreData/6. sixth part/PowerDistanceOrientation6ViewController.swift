...
class PowerDistanceOrientation6ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.powerDistanceOrientationQuestion6 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation1ViewController
            vc.user = user
        }
    }
...
extension PowerDistanceOrientation6ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.powerDistanceOrientationQuestion6 = fearLevel[row]
    }
}