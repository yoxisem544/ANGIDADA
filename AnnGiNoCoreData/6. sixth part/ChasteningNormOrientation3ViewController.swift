...
class ChasteningNormOrientation3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion3 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation4ViewController
            vc.user = user
        }
    }
...
extension ChasteningNormOrientation3ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.chasteningNormOrientationQuestion3 = fearLevel[row]
    }
}