...
class ChasteningNormOrientation6ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion6 = fearLevel[0]
    }
...
extension ChasteningNormOrientation6ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.chasteningNormOrientationQuestion6 = fearLevel[row]
    }
}