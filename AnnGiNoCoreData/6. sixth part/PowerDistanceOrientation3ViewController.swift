...
class PowerDistanceOrientation3ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PowerDistanceOrientation4ViewController
            vc.user = user
        }
    }
...
extension PowerDistanceOrientation3ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
