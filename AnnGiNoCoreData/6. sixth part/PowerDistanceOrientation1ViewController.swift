...
class PowerDistanceOrientation1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.powerDistanceOrientationQuestion1 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PowerDistanceOrientation2ViewController
            vc.user = user
        }
    }
...
extension PowerDistanceOrientation1ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.powerDistanceOrientationQuestion1 = fearLevel[row]
    }
}