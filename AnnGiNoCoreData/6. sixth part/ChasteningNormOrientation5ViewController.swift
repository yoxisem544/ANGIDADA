...
class ChasteningNormOrientation5ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation6ViewController
            vc.user = user
        }
    }
...
extension ChasteningNormOrientation5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
