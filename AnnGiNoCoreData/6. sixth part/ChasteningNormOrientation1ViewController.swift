...
class ChasteningNormOrientation1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion1 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation2ViewController
            vc.user = user
        }
    }
...
extension ChasteningNormOrientation1ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
