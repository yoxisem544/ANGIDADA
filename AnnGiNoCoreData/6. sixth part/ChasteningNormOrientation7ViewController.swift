...
class ChasteningNormOrientation7ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion7 = fearLevel[0]
    }
...
extension ChasteningNormOrientation7ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.chasteningNormOrientationQuestion7 = fearLevel[row]
    }
}