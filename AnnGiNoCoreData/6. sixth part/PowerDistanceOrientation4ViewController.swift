...
class PowerDistanceOrientation4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.powerDistanceOrientationQuestion4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PowerDistanceOrientation5ViewController
            vc.user = user
        }
    }
...
extension PowerDistanceOrientation4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
