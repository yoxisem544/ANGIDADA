...
class ChasteningNormOrientation2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion2 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation3ViewController
            vc.user = user
        }
    }
...
extension ChasteningNormOrientation2ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.chasteningNormOrientationQuestion2 = fearLevel[row]
    }
}