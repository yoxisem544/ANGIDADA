...
class ChasteningNormOrientation4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.chasteningNormOrientationQuestion4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ChasteningNormOrientation5ViewController
            vc.user = user
        }
    }
...
extension ChasteningNormOrientation4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.chasteningNormOrientationQuestion4 = fearLevel[row]
    }
}