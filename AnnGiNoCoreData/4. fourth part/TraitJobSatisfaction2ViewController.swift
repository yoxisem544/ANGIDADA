...
class TraitJobSatisfaction2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (43/72)"
        var backbutton = UIBarButtonItem(title: "43/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
        self.navigationItem.backBarButtonItem = backbutton
        // Do any additional setup after loading the view.
        fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
        user.traitJobSatisfactionQuestion2 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! TraitJobSatisfaction3ViewController
            vc.user = user
        }
    }
...
extension TraitJobSatisfaction2ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
