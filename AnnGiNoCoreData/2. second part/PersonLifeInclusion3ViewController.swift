...
class PersonLifeInclusion3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (23/72)"
        var backbutton = UIBarButtonItem(title: "23/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PersonLifeInclusion4ViewController
            vc.user = user
        }
    }
...
extension PersonLifeInclusion3ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
