...
class PerceivedSupervisorEffectiveness4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (36/72)"
        var backbutton = UIBarButtonItem(title: "36/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
...
extension PerceivedSupervisorEffectiveness4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
