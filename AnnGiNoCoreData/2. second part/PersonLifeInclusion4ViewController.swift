...
class PersonLifeInclusion4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.personLifeInclusionQuestion4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! DeferenceToSupervisor1ViewController
            vc.user = user
        }
    }
...
extension PersonLifeInclusion4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.personLifeInclusionQuestion4 = fearLevel[row]
    }
}