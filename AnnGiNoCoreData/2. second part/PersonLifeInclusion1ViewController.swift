...
class PersonLifeInclusion1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (21/72)"
        var backbutton = UIBarButtonItem(title: "21/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
        self.navigationItem.backBarButtonItem = backbutton
        // Do any additional setup after loading the view.
        fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
        user.personLifeInclusionQuestion1 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PersonLifeInclusion2ViewController
            vc.user = user
        }
    }
...
extension PersonLifeInclusion1ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
