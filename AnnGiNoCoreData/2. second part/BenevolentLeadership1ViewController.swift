...
class BenevolentLeadership1ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! BenevolentLeadership2ViewController
            vc.user = user
        }
    }
...
extension BenevolentLeadership1ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
