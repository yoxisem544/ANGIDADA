...
class GeneralSupervisorDirectedOCB3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (31/72)"
        var backbutton = UIBarButtonItem(title: "31/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! GeneralSupervisorDirectedOCB4ViewController
            vc.user = user
        }
    }
...
extension GeneralSupervisorDirectedOCB3ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
