...
class EmotionalJobDemand2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.emotionalJobDemandQuestion2 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! EmotionalJobDemand3ViewController
            vc.user = user
        }
    }
...
extension EmotionalJobDemand2ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.emotionalJobDemandQuestion2 = fearLevel[row]
    }
}