...
class QuantitativeJobDemand5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.quantitativeJobDemandQuestion5 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! EmotionalJobDemand1ViewController
            vc.user = user
        }
    }
...
extension QuantitativeJobDemand5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.quantitativeJobDemandQuestion5 = fearLevel[row]
    }
}