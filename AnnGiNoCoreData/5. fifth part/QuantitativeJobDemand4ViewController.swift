...
class QuantitativeJobDemand4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (53/72)"
        var backbutton = UIBarButtonItem(title: "53/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
        self.navigationItem.backBarButtonItem = backbutton
        // Do any additional setup after loading the view.
        fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
        user.quantitativeJobDemandQuestion4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! QuantitativeJobDemand5ViewController
            vc.user = user
        }
    }
...
extension QuantitativeJobDemand4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
