...
class QuantitativeJobDemand2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (51/72)"
        var backbutton = UIBarButtonItem(title: "51/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! QuantitativeJobDemand3ViewController
            vc.user = user
        }
    }
...
extension QuantitativeJobDemand2ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
