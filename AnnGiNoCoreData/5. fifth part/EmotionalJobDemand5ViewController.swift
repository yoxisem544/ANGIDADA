...
class EmotionalJobDemand5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "初始問卷".localized + " (59/72)"
        var backbutton = UIBarButtonItem(title: "59/72", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
        self.navigationItem.backBarButtonItem = backbutton
        // Do any additional setup after loading the view.
        fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
        user.emotionalJobDemandQuestion5 = fearLevel[0]
    }
...
extension EmotionalJobDemand5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
