//
//  LeaderMemberExchange7ViewController.swift
//  AnnGiNoCoreData
//
...
class LeaderMemberExchange7ViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		title = "事後問卷" + " (16/16)"
		var backbutton = UIBarButtonItem(title: "16/16", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
		self.navigationItem.backBarButtonItem = backbutton
		// Do any additional setup after loading the view.
		fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
		award.leaderMemberExchange7 = fearLevel[0]
	}
...
extension LeaderMemberExchange7ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
	...
	func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
		print(fearLevel[row])
		award.leaderMemberExchange7 = fearLevel[row]
	}
}