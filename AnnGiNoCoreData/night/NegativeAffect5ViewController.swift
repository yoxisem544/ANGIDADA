...
class NegativeAffect5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questionare.negativeAffect5 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! NegativeAffect6ViewController
...
extension NegativeAffect5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.negativeAffect5 = fearLevel[row]
    }
}