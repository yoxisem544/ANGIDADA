...
class NegativeAffect1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questionare.negativeAffect1 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! NegativeAffect2ViewController
...
extension NegativeAffect1ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.negativeAffect1 = fearLevel[row]
    }
}