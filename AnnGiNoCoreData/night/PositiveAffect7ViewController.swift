...
class PositiveAffect7ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questionare.positiveAffect7 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! PositiveAffect8ViewController
...
extension PositiveAffect7ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.positiveAffect7 = fearLevel[row]
    }
}