...
class BenevolentLeadershipRecieved5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "午間問卷".localized + " (10/10)"
        var backbutton = UIBarButtonItem(title: "10/10", style: UIBarButtonItemStyle.Done, target: nil, action: nil)
        self.navigationItem.backBarButtonItem = backbutton
        // Do any additional setup after loading the view.
        fearLevelPickerView.selectRow(0, inComponent: 0, animated: true)
        questionare.benevolentLeadershipReceived5 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! NoonLastConfirmViewController
...
extension BenevolentLeadershipRecieved5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.benevolentLeadershipReceived5 = fearLevel[row]
    }
}