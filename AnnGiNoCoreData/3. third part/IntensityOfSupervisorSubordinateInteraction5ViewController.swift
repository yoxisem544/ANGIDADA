...
class Intensity5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.intensityOfSupervisorSubordinateInteractionQuestion5 = fearLevel[0]
    }
...
extension Intensity5ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.intensityOfSupervisorSubordinateInteractionQuestion5 = fearLevel[row]
    }
}