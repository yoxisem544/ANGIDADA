...
class BenevolentLeadershipNeeded3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questionare.benevolentLeadershipNeeded3 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! BenevolentLeadershipNeeded4ViewController
...
extension BenevolentLeadershipNeeded3ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.benevolentLeadershipNeeded3 = fearLevel[row]
    }
}