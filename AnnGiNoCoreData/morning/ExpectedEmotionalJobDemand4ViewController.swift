...
class ExpectedEmotionalJobDemand4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questionare.expectedEmotionalJobDemand4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "next" {
            let vc = segue.destinationViewController as! ExpectedEmotionalJobDemand5ViewController
...
extension ExpectedEmotionalJobDemand4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        questionare.expectedEmotionalJobDemand4 = fearLevel[row]
    }
}