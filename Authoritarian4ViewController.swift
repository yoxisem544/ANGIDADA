...
class Authoritarian4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.authoritarianLeadershipQuestion4 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "14 to 15" {
            let vc = segue.destinationViewController as! Authoritarian5ViewController
            vc.user = user
        }
    }
    ...
    @IBAction func nextClicked(sender: AnyObject) {
        performSegueWithIdentifier("14 to 15", sender: user)
    }
}

extension Authoritarian4ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.authoritarianLeadershipQuestion4 = fearLevel[row]
    }
}