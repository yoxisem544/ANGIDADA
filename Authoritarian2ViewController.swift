...
class Authoritarian2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user.authoritarianLeadershipQuestion2 = fearLevel[0]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "12 to 13" {
            let vc = segue.destinationViewController as! Authoritarian3ViewController
            vc.user = user
        }
    }
    ...
    @IBAction func nextClicked(sender: AnyObject) {
        performSegueWithIdentifier("12 to 13", sender: user)
    }
}

extension Authoritarian2ViewController : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        print(fearLevel[row])
        user.authoritarianLeadershipQuestion2 = fearLevel[row]
    }
}